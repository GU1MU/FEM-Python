...
def intersects_box(
    ...
    *,
    ...
    """Select points whose bounding boxes overlap a closed query region.

    This is a conservative axis-aligned bounding-box test, not an exact
    geometric Boolean intersection. A point can match when its bounding box
    ...
    return _intersects_box(
        ...
        entities,
        dimension=0,
        operation="points.intersects_box",
        xmin=xmin,
        xmax=xmax,
        ymin=ymin,
        ymax=ymax,
...
def nearest_to(
    ...
    """Return the first point nearest to one OCC entity.
...
def within_distance(
    ...
    *,
    ...
    """Select points within an OCC entity-set distance threshold.
    ...
    return _within_distance(
        ...
        entities,
        dimension=0,
        operation="points.within_distance",

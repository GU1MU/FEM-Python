...
from ....elements.hex8.definition import hex8_gauss_points, hex8_shape_funcs_grads
from ....elements.hex20.definition import (
...
class _HexLinearOperatorBase:
    """Shared material and geometry helpers for hexahedral operators."""
...
class Hex8LinearOperator(_HexLinearOperatorBase):
    """Hex8 solid linear operator."""
    canonical_type = "Hex8"
    aliases = ("C3D8",)
    face_node_indices = [
        [0, 3, 2, 1],
...
class Hex20LinearOperator(_HexLinearOperatorBase):
    """Twenty-node quadratic serendipity hexahedron linear operator."""

...
class LinearElementService(Protocol):
    """Linear mechanics services for stiffness, loading, and recovery.

    Global assembly consumes local contributions through the physics
    contracts.  Recovery and load compilation use this richer mechanical
    service directly; it is not a second global assembly API.
    """
    canonical_type: str
    aliases: tuple[str, ...]

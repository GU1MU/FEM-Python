...
from fem.model import effective_displacement_constraints, model_element_info
from fem.model.targets import displacement_target_kind
from fem.model.validation import _entity_id, _integer_id, validate_mesh
...
def validate_analysis_step(model: Any, step: Any | None) -> None:
    ...
    _validate_step_references(
        ...
        model,
        effective_boundaries=effective_displacement_constraints(model, step),
    )
...
def _element_capabilities(element_type: Any) -> Any:
    """Resolve element capabilities at the analysis-validation boundary."""

...
_PATHS = {
    ...
    "back": "<path d='M20 19H4M20 19V4' stroke='#455a64' stroke-width='2.1'/><path d='M4 19l4-2.5v5z' fill='#d84a3a' stroke='none'/><path d='M20 4l-2.5 4h5z' fill='#3a9d5d' stroke='none'/><circle cx='20' cy='19' r='1.6' fill='#455a64' stroke='none'/><text x='4.2' y='15.4' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>X</text><text x='14' y='7.2' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Y</text>",
    "top": "<path d='M5 5H20M5 5V20' stroke='#455a64' stroke-width='2.1'/><path d='M20 5l-4-2.5v5z' fill='#d84a3a' stroke='none'/><path d='M5 20l-2.5-4h5z' fill='#e3a21a' stroke='none'/><circle cx='5' cy='5' r='1.6' fill='#455a64' stroke='none'/><text x='16.2' y='12.4' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>X</text><text x='8' y='20.5' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Z</text>",
    "bottom": "<path d='M5 19H20M5 19V4' stroke='#455a64' stroke-width='2.1'/><path d='M20 19l-4-2.5v5z' fill='#d84a3a' stroke='none'/><path d='M5 4L2.5 8h5z' fill='#e3a21a' stroke='none'/><circle cx='5' cy='19' r='1.6' fill='#455a64' stroke='none'/><text x='16.2' y='15.4' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>X</text><text x='8' y='7.2' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Z</text>",
    "left": "<path d='M5 19H20M5 19V4' stroke='#455a64' stroke-width='2.1'/><path d='M20 19l-4-2.5v5z' fill='#e3a21a' stroke='none'/><path d='M5 4L2.5 8h5z' fill='#3a9d5d' stroke='none'/><circle cx='5' cy='19' r='1.6' fill='#455a64' stroke='none'/><text x='16.2' y='15.4' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Z</text><text x='8' y='7.2' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Y</text>",
    "right": "<path d='M20 19H4M20 19V4' stroke='#455a64' stroke-width='2.1'/><path d='M4 19l4-2.5v5z' fill='#e3a21a' stroke='none'/><path d='M20 4l-2.5 4h5z' fill='#3a9d5d' stroke='none'/><circle cx='20' cy='19' r='1.6' fill='#455a64' stroke='none'/><text x='4.2' y='15.4' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Z</text><text x='14' y='7.2' fill='#66717b' stroke='none' font-size='6.2' font-weight='700'>Y</text>",
    "iso": "<path d='M12 12l9 6M12 12l-9 6M12 12V3' stroke='#455a64' stroke-width='2.1'/><path d='M21 18l-4.6-.4 2.5-3.8z' fill='#d84a3a' stroke='none'/><path d='M3 18l2.1-4.2 2.5 3.8z' fill='#e3a21a' stroke='none'/><path d='M12 3L9.5 7h5z' fill='#3a9d5d' stroke='none'/><circle cx='12' cy='12' r='1.6' fill='#455a64' stroke='none'/><text x='18' y='13.5' fill='#66717b' stroke='none' font-size='5.5' font-weight='700'>X</text><text x='14.5' y='6.5' fill='#66717b' stroke='none' font-size='5.5' font-weight='700'>Y</text><text x='2' y='13.5' fill='#66717b' stroke='none' font-size='5.5' font-weight='700'>Z</text>",
    ...
    "animation": "<rect x='3' y='5' width='18' height='14' rx='1.5'/><path d='M7 5v14M17 5v14' stroke='#71808a' stroke-width='1.2'/><path d='M10 9l5 3-5 3z' fill='#2f80c9' stroke='none'/>",
    "xy_data": "<path d='M4 19V5M4 19h17'/><path d='M6 15l4-4 3 2 5-6 3 2' stroke='#2f80c9' stroke-width='2.2'/>",
    "previous_frame": "<path d='M7 5v14'/><path d='M19 6l-9 6 9 6z' fill='#2f80c9' stroke='none'/>",
    "first_frame": "<path d='M6 5v14'/><path d='M18 6l-9 6 9 6z' fill='#2f80c9' stroke='none'/><path d='M3 5v14'/>",
    "play": "<path d='M8 5l10 7-10 7z' fill='#2f80c9' stroke='none'/>",
    "stop": "<rect x='7' y='7' width='10' height='10' fill='#d9534f' stroke='none'/>",
    "next_frame": "<path d='M17 5v14'/><path d='M5 6l9 6-9 6z' fill='#2f80c9' stroke='none'/>",
    "last_frame": "<path d='M18 5v14'/><path d='M6 6l9 6-9 6z' fill='#2f80c9' stroke='none'/><path d='M21 5v14'/>",
    # Vector fallback used if the packaged PNG resource cannot be loaded.

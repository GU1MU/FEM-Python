...
def test_state_field_is_wide_and_keeps_full_status_as_tooltip(gui_application) -> None:
...
def test_object_field_is_wider_than_selection_field(gui_application) -> None:
    application = gui_application
    status_bar = CAEStatusBar()
    status_bar.resize(1200, 22)
    status_bar.show()
